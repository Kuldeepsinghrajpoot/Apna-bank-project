            ...
            <div class="authentication-inner">
               ...
               <div class="card">
                  <div class="card-body">
                     ...
                     <!-- /Logo -->
                     <h4 class="mb-2">Register in apna bank</h4>
                     ...
                     <form id="formAuthentication" class="mb-3">
                        ...
                        <div class="mb-3">
                           ...
                           <input type="date" class="form-control" id="dob" name="dob" placeholder="Last Name" required/>
                        </div>
                        <div class="mb-3">
                        ...
                        <div class="mb-3 form-password-toggle">
                           ...
                           <div class="input-group input-group-merge">
                              <input type="password" id="password" class="form-control" name="password" required
                                 placeholder="&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;"
                                 aria-describedby="password" maxlength="7" />
                        ...
                        <button class="btn btn-primary d-grid w-100" type="button" onclick="submit_page()">Sign up</button>
                     </form>
                     <p class="text-center">
